...
function generarContenedorVariablesAct(tipo, compNum, actNum, indNum){
  ...
  const actUnvarHTML = `
    ...
    <div class="row" style:"display:flex">
        ...
        <input type="text" id="name_b_componente_${compNum}_actividad_${actNum}_indicador_${indNum}" name="name_b_componente_${compNum}_actividad_${actNum}_indicador_${indNum}" placeholder="Escribe el nombre" style="border: none !important; width: 100%; height:100%;">
        </div>
        <div class="col" style="flex: 1;">
  ...
  <div class="row" style:"display:flex">
      ...
      <div class="col" style="flex: 1;">
       <input type="text" id="name_c_componente_${compNum}_actividad_${actNum}_indicador_${indNum}" name="name_c_componente_${compNum}_actividad_${actNum}_indicador_${indNum}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;height:100%;">
      </div>
      <div class="col" style="flex: 1;">
  ...
  <div class="row" style:"display:flex">
      ...
      <div class="col" style="flex: 1;">
       <input type="text" id="name_d_componente_${compNum}_actividad_${actNum}_indicador_${indNum}" name="name_d_componente_${compNum}_actividad_${actNum}_indicador_${indNum}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;height:100%;">
      </div>
      <div class="col" style="flex: 1;">
