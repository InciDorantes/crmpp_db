...
const UnvarHTML = `
        <div class="row" style="display: flex;">
            <div class="col" style="width: 5%  !important; background-color: gainsboro !important;">
            Variable
            </div>
            <div class="col" style="width: 20%  !important; background-color: gainsboro!important;">
            Nombre
            </div>
            <div class="col" style="width: 25%  !important; background-color: gainsboro !important;">
        ...
        <div class="row" style="display: flex;">
            ...
            <div class="col" style="width:20%  !important;">
             <input type="text" id="fin_name_b" name="fin_name_b" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
            </div>
...
const DosvarHTML = `
        ...
        <div class="row">
            ...
            <div class="col">
             <input type="text" id="fin_name_c" name="fin_name_c" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
            </div>
            <div class="col">
...
const TresvarHTML = `
  ...
  <div class="row">
    ...
    <div class="col">
     <input type="text" id="fin_name_d" name="fin_name_d" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
    </div>
    <div class="col">
...
const propUnvarHTML = `
  ...
  <div class="row">
      ...
      <div class="col">
       <input type="text" id="proposito_name_b_${numIndicador}" name="proposito_name_b_${numIndicador}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
      </div>
      <div class="col">
...
const propDosvarHTML = `
  ...
  <div class="row">
    ...
    <div class="col">
     <input type="text" id="proposito_name_c_${numIndicador}" name="proposito_name_c_${numIndicador}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
    </div>
    <div class="col">
...
const propTresvarHTML = `
  ...
  <div class="row">
    ...
    <div class="col">
     <input type="text" id="proposito_name_d_${numIndicador}" name="proposito_name_d_${numIndicador}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
    </div>
    <div class="col">
