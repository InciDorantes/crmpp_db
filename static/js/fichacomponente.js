...
function generarContenedorVariables(tipo, componente,indicador){
  ...
  <div class="row">
      ...
      <div class="col">
       <input type="text" id="name_b_${componente}_${indicador}" name="name_b_${componente}_${indicador}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
      </div>
      <div class="col">
  ...
  <div class="row">
      ...
      <div class="col">
       <input type="text" id="name_c_${componente}_${indicador}" name="name_c_${componente}_${indicador}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
      </div>
      <div class="col">
  ...
  <div class="row">
      ...
      <div class="col">
       <input type="text" id="name_d_${componente}_${indicador}" name="name_d_${componente}_${indicador}" placeholder="Escribe el nombre" style="border: none !important; width: 100%;">
      </div>
      <div class="col">
